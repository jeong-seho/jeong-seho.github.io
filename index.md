...
<section id="research" class="content-section page-section">
    <h1>Research</h1>
    ...
    <div class="paper">
        <div class="paper-title">
            Nullam est nulla, convallis placerat purus ac
        </div>
